...
import { bhajanServiceName } from '../../constants/bhajan';

const formatCurrency = (value) => `₹${value.toLocaleString('en-IN', { maximumFractionDigits: 0 })}`;

export default function BhajanConfirmation() {
    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.detailCard}>
          <Text style={[textVariants.heading4, styles.eventTitle]}>{bhajanServiceName}</Text>
