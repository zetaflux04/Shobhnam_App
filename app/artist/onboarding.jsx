...
const steps = [
  {
    icon: <Ionicons name="calendar-outline" size={moderateScale(20)} color="white" />,
    title: 'Step 1',
    subtitle: 'Set your availability.',
  },
  {
    icon: <MaterialIcons name="event-note" size={moderateScale(20)} color="white" />,
    title: 'Step 2',
    subtitle: 'Get your events schedule.',
  },
  {
    icon: <Ionicons name="people-outline" size={moderateScale(20)} color="white" />,
    title: 'Step 3',
    subtitle: 'Perform and Connect with users!',
  },
];
...
export default function ArtistOnboardingScreen() {
  return (
    <SafeAreaView style={styles.safeArea}>
      <ImageBackground
        source={require('../../assets/images/onboard-2.jpg')}
        style={styles.background}
        resizeMode="cover"
      >
        <LinearGradient
          colors={['rgba(0,0,0,0.0)', 'rgba(0,0,0,0.24)', 'rgba(0,0,0,0.36)']}
        ...
        <View style={styles.cardContainer}>
          ...
          <TouchableOpacity style={styles.nextButton} activeOpacity={0.9} onPress={() => router.push('/artist/phone')}>
