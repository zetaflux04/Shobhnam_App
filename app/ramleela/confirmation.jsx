...
import { ramleelaServiceName } from '../../constants/ramleela';

const formatCurrency = (value) => `₹${value.toLocaleString('en-IN', { maximumFractionDigits: 0 })}`;

export default function RamleelaConfirmation() {
    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.detailCard}>
          <Text style={[textVariants.heading4, styles.eventTitle]}>{ramleelaServiceName}</Text>
