/**
 * @typedef {Object} RamleelaPackage
 * @property {string} id
...
export const ramleelaServiceName = 'Ramleela';

/** @type {RamleelaPackage[]} */
export const ramleelaPackages = [
  {
    id: 'diamond',
    title: 'Diamond package.',
    description: 'The most immersive Ramleela experience with best artists.',
    price: 11000,
  ...
  },
  {
    ...
    description: 'A rich Ramleela experience with skilled artists.',
    price: 8100,
  ...
  },
  {
    id: 'gold',
    title: 'Gold package.',
    description: 'A meaningful traditional Ramleela experience.',
    price: 5100,
  ...
  },
  {
    ...
    description: 'A simple and short Ramleela experience.',
    price: 3100,
...
export const ramleelaAddresses = [
...
export const ramleelaCalendar = {
  monthLabel: 'Januari 2026',
  days: Array.from({ length: 31 }, (_, idx) => idx + 1),
  highlightedDay: 15,
};

export const ramleelaTimeSlots = ['8:00 AM', '9:00 AM', '6:00 PM', '10:00 PM', '11:00 PM', '12:00 PM'];

export const ramleelaFees = {
  base: 550,
  total: 11000,
};
